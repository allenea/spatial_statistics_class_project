...
THIS IS NOT THE MOST EFFICIENT WAY TO DO THIS..... Basically would need to drop last 2 columns and change column names
then drop last 2 columns, then replace the data. Sort by date and then save to text file
Missing Dew Point Temperature

{'13764': 'KGED', '03726': 'KWWD', '13707': 'KDOV', '13735': 'KMIV', '93739': 'KWAL', '00356': 'KCGE', '93720': 'KSBY', '93786': 'KOXB', '03756': 'KESN', '93730': 'KACY'} 
...
HEADER = ['ID_String', 'DATE','Wind_Speed','Wind_Direction','Air_Temperature','Dewpoint_Temperature',\
          'Relative Humidity','Pressure','Latitude','Longitude','Elevation','Name_string','FM_string','Source_string']
...
for file in filelist:
    ...
    np.savetxt(outdir+"/all_verification_"+str(file[10:13])+"data_BADARC.txt", prep4r.values, fmt='%10s %20s %13.5f %13.5f %13.5f %13.5f %13.5f %13.5f %20.5f %20.5f %13.5f %40s %20s %40s')
