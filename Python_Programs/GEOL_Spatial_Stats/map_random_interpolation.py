...
for case_time in casestudy_time:
    ...
    data.columns.tolist()
    short_data = data[:num_random_locs]
    ...
    ax1.set_title("Locations of Interpolated Observation Data for "+case_time[:10]+" Simulation" ,va='bottom', fontsize=20)
    ...
    ax1.plot(Longitude, Latitude, 'o', color='r',markersize=10, transform=ccrs.PlateCarree())
    ...
    plt.savefig(os.getcwd()+'/Final_INTERP_MAP'+case_time[:10].replace("-","_")+'.png')
    plt.show()
