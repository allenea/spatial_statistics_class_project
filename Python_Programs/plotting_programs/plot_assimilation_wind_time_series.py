...
for case_time in casestudy_time:
    ...
    for dtype1 in dtype_subusage:
        ...
        for datype in dtype_usage:
            ...
            if isRaw == True:
                outdir =  mydir+"/plots/Delaware_Surface_Winds/WSPD/"
            elif isRaw == False:
                outdir =  mydir+"/plots/Delaware_Surface_Winds/WSPD/"
        ...
        for fileDIR in filelst:
            ...
            ax2.set_ylabel('Wind Speed (kt)', fontsize=16,fontweight='bold')
            ...
            plt.savefig(outdir + "DEOS_Time_Series_Windspeed"+case_time[:10].replace("-","_")+"_NEW.png")
            #plt.show()
