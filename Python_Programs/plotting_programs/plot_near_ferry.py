        ...
        for dtype1 in dtype_subusage:
            ...
            for datype in dtype_usage:
                ...
                if isRaw == True:
                    ...
                    outdir =  mydir+"/plots/Near_Ferry/AVG/LINE/"
                        ...
                        ID_String[0] == "44009" or ID_String[0] == "LWSD1" or ID_String[0] == "DCPH" or ID_String[0] == "DLEW" or  ID_String[0] == "DEL03" or\
                         ID_String[0] == "DRHB" or ID_String[0] == "MWCM":
                            ...
                            if ID_String[0] == "CMLF":
                                ...
                                ax.plot(time,variable_data,linestyle=None,label=ID_String[0])
            ...
            if isRaw == True:
                if "Wind_Speed (m/s)" in variable and dtype1 == "10m":
                    plt.title("Observed "+dtype1+" Wind Speeds (m/s) Near Ferry On "+case_time, fontsize=20)
                    
                elif "Wind_Speed (m/s)" in variable and dtype1 == "original":
                    plt.title("Observed Wind Speeds (m/s) Near Ferry On "+case_time, fontsize=20)
            ...
            if isRaw == True:
                plt.savefig(outdir+"NEAR_FERRY_Time-Series_plot_"+dtype1+"_"+variable[:-6]+"_"+case_time[0:10]+".png")
            else:
                plt.savefig(outdir+"NEAR_FERRY_Time-Series_plot_"+dtype1+"_"+variable[:-6]+"_"+case_time[0:10]+".png")
            plt.close()