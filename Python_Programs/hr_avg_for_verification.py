...
#### Not tested to entire years also I have the days bound by max and min to speed things up and only give what I want.
...
for case_time in casestudy_time:
    for usage in dtype_usage:
        for dtype in dtype_subusage:
            ...
            #case_time ="2014-06-04"#"2015-08-14" #"2015-08-14" #
            #dtype = 'original'  #  dtype ='10m' #
            #datadir = '/Users/allenea/Documents/Eric_Allen/Verification_Data/verify_case_study_data/'+dtype+'/'
            ##datadir = '/Users/allenea/Documents/Eric_Allen/Ferry_Data/case_study_data/'+dtype+'/'
            #
            #outdir = "/Users/allenea/Documents/Eric_Allen/Verification_Data/hr_avg_verify/"+dtype+"/"+case_time+"/"
            ##outdir = "/Users/allenea/Documents/Eric_Allen/Ferry_Data/hr_avg_verify/"+dtype+"/"+case_time+"/"
            #
            #if not os.path.exists(outdir):
            #    os.makedirs(outdir)
